...
const CURATED_LEGS = {
  ...
  "barcelona|porto":          { hours: 4.6,  mode: "flight",    note: "No practical rail link — Ryanair/Vueling, ~2h in the air (time shown door-to-door)" },
  ...
  "lisbon|madrid":            { hours: 3.9,  mode: "flight",    note: "No direct day train — ~1.2h in the air (time shown door-to-door); sleeper train also runs" },
